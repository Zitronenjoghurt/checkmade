...
pub enum ClientMessage {
    ...
    RemoveSessionRequest(SessionRequestId),
...
impl ClientMessage {
    ...
    pub fn cost(&self) -> f64 {
        match self {
            ...
            Self::RemoveFriendRequest(_) => 3.0,
            Self::RemoveSessionRequest(_) => 3.0,
            Self::SendFriendRequest { .. } => 3.0,
            Self::Session(_) => 3.0,
            Self::SessionHistory => 30.0,
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::RemoveFriendRequest(_) => "remove_friend_request",
            Self::RemoveSessionRequest(_) => "remove_session_request",
